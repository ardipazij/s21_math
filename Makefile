...
test: s21_math.a
	gcc $(LDFLAGS) -o test math_test.c s21_math.a $(ADD_LIB) -lcheck
	./test
...
clean:
	-rm -rf *.o *.gcda *.gcno *.gcov *result coverage.info s21_test.info s21_math.a test report
